...
namespace WebApiContrib.Selectors
{
    ...
    public class NamespaceHttpControllerSelector : DefaultHttpControllerSelector
    {
        ...
        public override HttpControllerDescriptor SelectController(HttpRequestMessage request)
        {
            ...
            if (routeData == null || routeData.Route == null || routeData.Route.DataTokens == null || routeData.Route.DataTokens["_namespace"] == null)
            ...
            var _namespace = routeData.Values["_namespace"] as string;
            if (_namespace == null)
                return base.SelectController(request);
            ...
            var found = _duplicateControllerTypes.Value
              ...
              .FirstOrDefault(x => x.Namespace == _namespace);
